...
// Firebase projesine bağlan
const projectId = 'devkom-dfdca';

// Firebase Admin SDK'yı initialize et (Application Default Credentials kullanarak)
admin.initializeApp({
  projectId: projectId,
});
...
async function importQuestions() {
  console.log('Sorular Firestore\'a ekleniyor...');
