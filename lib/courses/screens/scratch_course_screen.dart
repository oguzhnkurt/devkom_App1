...
class ScratchCourseScreen extends StatefulWidget {
  final Course course;

  const ScratchCourseScreen({super.key, required this.course});

  @override
  State<ScratchCourseScreen> createState() => _ScratchCourseScreenState();
}

class _ScratchCourseScreenState extends State<ScratchCourseScreen> {
  ...
  Widget _buildLessonCard(InteractiveLesson lesson, int index, bool isDark) {
    final isCompleted = false; // TODO: Get from user data
    final isLocked = false; // For now, don't lock
  ...
  void _startFirstAvailableLesson() {
    ...
    final firstLesson = ScratchLessonsData.allLessons.first;
    _openLesson(firstLesson);
  }
}
...
class _AnimatedScratchCat extends StatefulWidget {
  @override
  State<_AnimatedScratchCat> createState() => _AnimatedScratchCatState();
}

class _AnimatedScratchCatState extends State<_AnimatedScratchCat>
